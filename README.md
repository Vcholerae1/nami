...
For installation, usage, and other tasks, paste the following into your coding agent:

```text
Read and follow https://github.com/barkure/nami/blob/main/AGENTS.md, before install, usage, or code changes. If it conflicts with defaults, prefer AGENTS.md.
```

## Acknowledgements

nami stands on the shoulders of the projects doing the real work in wave modelling, FWI, and differentiable FDTD:

- [ar4/deepwave](https://github.com/ar4/deepwave)
- [DeepWave-KAUST/sweep](https://github.com/DeepWave-KAUST/sweep)
...
nami is licensed under the [MIT License](./LICENSE).
